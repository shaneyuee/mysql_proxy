...
typedef pb_wire_type_t knv_type_t;
typedef pb_field_val_t knv_field_val_t;
typedef pb_field_t knv_field_t;
typedef pb_buff_t knv_buff_t;

#define KNV_VARINT  PB_WT_VARINT
#define KNV_FIXED64 PB_WT_FIXED64
#define KNV_STRING  PB_WT_STRING
#define KNV_FIXED32 PB_WT_FIXED32
