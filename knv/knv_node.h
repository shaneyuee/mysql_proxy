 ...
 * Shaneyu@tencent.com
 *
 * 2013-10-12	shaneyu 	Created
 * 2013-11-04	shaneyu 	Add parent pointer and eval_size to optimize folding
 * 2014-01-17   shaneyu         Use mem_pool for dynamic memory management
 * 2014-01-28   shaneyu         Use KnvHt to optimize hash initialization
 * 2014-05-17   shaneyu         Meta use KnvNode instead of KnvLeaf
 *
 */
...
public: // API for data operations
	...
	KnvNode *GetParent() { return parent; }
